...
<body>
  ...
  <section>
    ...
    <ul>
      ...
      <li>🧠 <strong>Data Engineering:</strong> SQL, data pipelines, automation, A/B testing</li>
  ...
  <section>
    ...
    <ul>
      <li>🌐 A full-stack wellness app for habit tracking</li>
      <li>🧪 Automating fitness recommendations with AI</li>
      <li>☁️ Prepping for AWS Cloud Practitioner Certification (May 2025)</li>
    </ul>
  </section>
  ...
  <section>
    <h2>🧜🏻‍♀️ Fun Fact</h2>
    <p>When I’m not writing code or wrangling data, you can probably find me at the beach soaking up vitamin E and sea 🌞🌊</p>
  </section>
